...
export async function POST(
  ...
  const correction = await prisma.boilerLog.create({
    data: {
      ...
      steamTemperature: original.steamTemperature,
      feedwaterPressure: original.feedwaterPressure,
      feedwaterTemperature: original.feedwaterTemperature,
      condensateReturnTemp: original.condensateReturnTemp,
      waterLevel: original.waterLevel,
      feedPumpStatus: original.feedPumpStatus,
      alternatePumpStatus: original.alternatePumpStatus,
      fuelPressure: original.fuelPressure,
      airPressure: original.airPressure,
      fanFrequency: original.fanFrequency,
      modulationPosition: original.modulationPosition,
      ...
      combustion: original.combustion
        ? {
            create: {
              flueGasTemperature: original.combustion.flueGasTemperature,
              o2: original.combustion.o2,
              co: original.combustion.co,
              co2: original.combustion.co2,
              excessAir: original.combustion.excessAir,
              estimatedEfficiency: original.combustion.estimatedEfficiency,
              fuelConsumption: original.combustion.fuelConsumption,
              steamFlow: original.combustion.steamFlow,
            },
          }
        : undefined,
      waterTreatment: original.waterTreatment
        ? {
            create: {
              ...
              conductivity: original.waterTreatment.conductivity,
              tds: original.waterTreatment.tds,
              hardness: original.waterTreatment.hardness,
              sulfites: original.waterTreatment.sulfites,
              phosphates: original.waterTreatment.phosphates,
              alkalinity: original.waterTreatment.alkalinity,
              chlorides: original.waterTreatment.chlorides,
